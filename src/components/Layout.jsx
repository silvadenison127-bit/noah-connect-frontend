...
import {
  ...
  Sparkles, BarChart3, MapPin, Moon, GraduationCap, Radio, MessageSquare, UserPlus
} from "lucide-react";
...
const GRUPOS_MENU = [
  ...
  },
  {
    ...
    itens: [
      ...
      { icone: UserPlus, nome: "Visitantes", rota: "/visitantes" },
    ],
  },
  {
    titulo: "Operação",
    itens: [
      ...
      { icone: MessageSquare, nome: "Chat", rota: "/chat" },
